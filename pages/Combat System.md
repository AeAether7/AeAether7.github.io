- Combat in Nebu is broken down into two states. The attacking state, and the defending state. For the sake of the explanation, I will be describing a 2v2 battle between 4 NPCS while explaining the combat system. To keep it simple, all 4 NPCS will have 100 health and no perks or stat point bonuses.
- ## Part 1: Action Values
  collapsed:: true
	- To start the battle, all 4 NPCS roll for their action values. The default roll for this value is a 1d20, but this can be altered by either perks or status effects. For simplicity sake, I will be using the default value for all 4 NPCS
	- Hero 1 rolled 16
	  Hero 2 rolled 8
	  Villain 1 rolled a 19
